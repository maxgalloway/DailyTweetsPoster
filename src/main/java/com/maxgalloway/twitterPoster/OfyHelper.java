package com.maxgalloway.twitterPoster;
 ...
 * required to let JSPs access Ofy.
 * 
...
public class OfyHelper implements ServletContextListener {
  public void contextInitialized(ServletContextEvent event) {
    ...
    ObjectifyService.register(RedditPost.class);
    ObjectifyService.register(RedditAuth.class);
  }
